...
var MdePreview = /** @class */ (function (_super) {
    ...
    MdePreview.prototype.render = function () {
        var _this = this;
        var _a = this.props, className = _a.className, minHeight = _a.minHeight, loadingPreview = _a.loadingPreview;
        ...
        if (typeof finalHtml === "string") {
            content = React.createElement("div", { className: "mde-preview-content", dangerouslySetInnerHTML: { __html: finalHtml || "<p>&nbsp;</p>" }, ref: function (p) { return _this.previewRef = p; } });
        }
        else {
            content = React.createElement("div", { className: "mde-preview-content" }, finalHtml);
        }
        return (React.createElement("div", { className: ClassNames_1.classNames("mde-preview", { className: className, loading: loading }), style: { minHeight: minHeight + 10 } }, content));
    };
    return MdePreview;
}(React.Component));
